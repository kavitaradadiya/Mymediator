                                    ...
                                    <div className="modal fade" id="staticBackdrop" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
                                        <div className="modal-dialog  modal-lg model_size">
                                            <div className="modal-content">
                                                <div className="modal-body model_padding ">
                                                    <div className='row'>
                                                                            ...
                                                                            <div className="modal-body">
                                                                                <div className='row'>
                                                                                    <div className='col-lg-6 col-md-6 col-sm-6 col-6'>
                                                                                        <h5 className="modal-title text-center fw-bold mb-5" id="staticBackdropLabel">Sign Up</h5>
                                                                                        <div className='mt-4'>
                                ...
                                <div className="collapse navbar-collapse" id="navbarNav">
                                   ...
                                   <ul className="navbar-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link text-dark" >Property</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link text-dark" to="/property" >Electronics</Link>
                                        </li>
                                        <li className="nav-item">
